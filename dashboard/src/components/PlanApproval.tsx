...
export function PlanApproval({ taskId, planText, onApproved }: Props) {
  ...
  return (
    <div className="border border-yellow-300 bg-yellow-50 rounded-lg p-4">
      ...
      <pre className="bg-white border border-gray-200 rounded-md p-3 text-xs overflow-auto max-h-[300px] mb-3 whitespace-pre-wrap">
        {planText}
      </pre>
      <textarea
        value={comment}
